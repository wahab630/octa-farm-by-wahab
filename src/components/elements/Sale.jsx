        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="row">
                <div className="col-lg-4 sale-card text-center">
                ...
                <div className="col-lg-3 offset-lg-1 text-center sale-card-two">
                ...
                <div className="col-lg-3 offset-lg-1 sale-card-three text-center">
